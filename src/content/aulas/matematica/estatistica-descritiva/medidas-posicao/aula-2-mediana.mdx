...
### 2.1 Mediana para Dados Brutos (Não Agrupados)
...
### 2.2 Mediana para Dados Agrupados por Lista
...
### 2.3 Mediana para Dados Agrupados por Intervalo de Classe
...
#### 2.5 Vantagens e Desvantagens da Mediana
...
> Se a média e a mediana forem **próximas**, a distribuição é aproximadamente simétrica e a média pode ser usada.
>

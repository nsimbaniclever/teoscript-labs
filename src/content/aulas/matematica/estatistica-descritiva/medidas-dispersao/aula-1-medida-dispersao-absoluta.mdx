...
&emsp;&emsp;&emsp;As medidas de tendência central (média, mediana e moda) e as separatrizes (quartis, decis e percentis) respondem todas à mesma pergunta: "Onde está o centro dos dados?" Mas nenhuma responde a uma pergunta igualmente fundamental: "Quão espalhados estão os dados?"**<br>
